...
Both add information to the previous commit. But, ammend add new lines
of code and a new commit message. While extend only adds new lines of
code, without changing the commit message.
