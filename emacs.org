...
SCHEDULED: <2021-11-02 ter>
:PROPERTIES:
:ID:       b95a901b-aa89-44a0-a2c3-6ef75e513217
:DRILL_LAST_INTERVAL: 4.0
:DRILL_REPEATS_SINCE_FAIL: 2
:DRILL_TOTAL_REPEATS: 1
:DRILL_FAILURE_COUNT: 0
...
How to delete all whitespaces untill a character?

**** Answer

=M-\= which is bounded to =delete-horizontal-space=
...
How to inspect the object without needing to right click with the mouse?
...
How to capitalize a word, for instance, from "lisp"->"Lisp"?
